...
namespace Veganko.ViewModels
{
    public class ProfileViewModel : BaseUserProfileViewModel
    {
            ...
            : base(true)
        {
            ...
            MessagingCenter.Subscribe<ProductModRequestDetailViewModel, ProductModRequestViewModel>(this, ProductModRequestDetailViewModel.RemoveItemMsg, OnProductModReqDeleted);
