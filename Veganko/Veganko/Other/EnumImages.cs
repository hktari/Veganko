...
namespace Veganko
{
    public static class EnumImages
    {
        ...
        public static Dictionary<ProductClassifier, string> ProductClassifierImages => new Dictionary<ProductClassifier, string>
        {
            { ProductClassifier.Vegeterijansko, "vegan.png" },
            { ProductClassifier.Vegansko, "vegan.png" },
            { ProductClassifier.Pesketarijansko, "vegan.png" },
            { ProductClassifier.GlutenFree, "vegan.png" },
            { ProductClassifier.RawVegan, "vegan.png" },
            { ProductClassifier.CrueltyFree, "vegan.png" },
        };
